...
/* Don't need these since we're not in booter
int strcpy(char *destination, char *source)
{
	...
	destination[i] = 0;		// Terminate destination string
...
{
	int length = 0, i = 0, MAXLEN = 32767;

	while (string[i] && i < MAXLEN)
		length++;
